...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.car_name, c.car_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare
...
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 5px; text-align: center; font-size: 30px;"> Détails du voyage </h3>

           <h5> Voiture:&nbsp;  <?php echo($car_name);?></h5>

           <h5> Immatriculation:&nbsp;  <?php echo($car_nameplate);?></h5>

           <h5> Date Location date:&nbsp;  <?php echo($rent_start_date);?></h5>

           <h5> Date fin location:&nbsp;  <?php echo($rent_end_date);?></h5>

           <h5> Tarif:&nbsp;   <?php echo ($fare . "/Jour")?>;
               
            </h5>

           
         
            <h5> Nombre de jours:&nbsp;  <?php echo($no_of_days);?></h5>
            <input type="hidden" name="distance_or_days" value="<?php echo $no_of_days; ?>">
          
          <input type="hidden" name="hid_fare" value="<?php echo $fare; ?>">

           <input type="submit" name="submit" value="Valider" class="btn btn-success pull-right">    
        </form>
      </div>
    </div>
