...
<div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Rendre la voiture ici</h1>
        <p class="text-center"> Nous éspérons que vous avez apprécié notre service </p>
      </div>
    </div>
...
<th width="20%">Date début locattion</th>
<th width="20%">Date début locattion</th>
...
<?php        } ?>
        ...
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Pas de voiture à rendre.</h1>
