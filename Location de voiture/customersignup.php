...
<body>
            ...
            ?>
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="#"><span class="glyphicon glyphicon-user"></span> Bienvenu <?php echo $_SESSION['login_client']; ?></a>
                        </li>
                        <li>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Ouriemi Location - Enregistrement</h1>
            <br>
            <p class="text-center">Commençons par créer votre compte</p>
        </div>
    </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_name"><span class="text-danger" style="margin-right: 5px;">*</span> Nom et prénom: </label>
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_username"><span class="text-danger" style="margin-right: 5px;">*</span> Nom d'utlisateur: </label>
                                <div class="input-group">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_phone"><span class="text-danger" style="margin-right: 5px;">*</span> Tel: </label>
                                <div class="input-group">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-contact" aria-hidden="true"></span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_address"><span class="text-danger" style="margin-right: 5px;">*</span> Addresse: </label>
                                <div class="input-group">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <label style="margin-left: 5px;"><a href="customerlogin.php">Vous avez un compte? Entrer.</a></label>
