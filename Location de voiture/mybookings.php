...
<div class="container">
      <div class="jumbotron">
        ...
        <p class="text-center"> Nous espérons que vous avez apprécié notre service </p>
      </div>
    </div>
...
<td><?php echo $row["fare"]; ?> Dt/jour</td>
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Vous n'avez pas loué de voitures jusqu'à présent!</h1>
        <p class="text-center"> Veuillez louer des voitures afin de voir vos données ici. </p>
      </div>
    </div>
