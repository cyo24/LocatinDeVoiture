...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Ouriemi Location</h1>
                            <p class="intro-text">
                                Service en ligne de location de voiture
                            </p>
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Voitures Disponibles</h3>
<br>
        <section class="menu-content">
            <?php   
            $sql1 = "SELECT * FROM cars WHERE car_availability='oui'";
            ...
            <img class="card-img-top" src="administration/admin/<?php echo $car_img; ?>" alt="Card image cap">
            <h5><b> <?php echo $car_name; ?> </b></h5>
            <h6> Tarif : <?php echo  $non_ac_price; ?></h6>
            ...
            <?php }}
                ...
                ?>
<h1> Pas de voiture disponible :( </h1>
                <?php
            }
            ?>                                   
        </section>
