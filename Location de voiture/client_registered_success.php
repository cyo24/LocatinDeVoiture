<html>
  ...
  <head>
    <title> Enregistremnt Client | Car Rentals </title>
        ...
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="clientview.php">View</a></li>
                    ...
                    <li>
                        <a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Deconexion</a>
                    </li>
                </ul>
            </div>
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Garagge <span class="caret"></span> </a>
              ...
              <li> <a href="mybookings.php"> Mes reservations</a></li>
            </ul>
            </li>
          </ul>
                    <li>
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		<h2> <?php echo "Bienvenu $client_name!" ?> </h2>
		<h1>Votre compte a été crée avec succées.</h1>
		<p>Vous pouvez vous identifier <a href="clientlogin.php">ici</a></p>
	</div>
</div>
